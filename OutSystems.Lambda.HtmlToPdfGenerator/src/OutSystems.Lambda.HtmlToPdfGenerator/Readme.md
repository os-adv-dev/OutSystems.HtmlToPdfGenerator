...
Execute unit tests
```
    cd "OutSystems.Lambda.HtmlToPdfGenerator/test/OutSystems.Lambda.HtmlToPdfGenerator.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "OutSystems.Lambda.HtmlToPdfGenerator/src/OutSystems.Lambda.HtmlToPdfGenerator"
