...
namespace OutSystems.Lambda.HtmlToPdfGenerator;
...
public class Function
{
    ...
    {
        Func<string, ILambdaContext, Task<byte[]>> handler = FunctionHandler;
    ...
    /// <returns></returns>
    public static async Task<byte[]> FunctionHandler(string input, ILambdaContext context)
    {
        ...
        return await pdfGenerator.GeneratePdf(htmlOrUrl, source, orientation, size);
    }
}
